...
function Register({ toggleMode }: LoginProps) {
  ...
  return (
    <section onClick={(e) => e.stopPropagation()} className=" z-50 w-[700px] py-10 ">
              ...
              <div className=" bg-[#1F2937] bg-opacity-50 rounded-lg w-full shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                 ...
                 <Fade direction="up" triggerOnce>
                    ...
                    <p
                      onClick={toggleMode}  className="font-medium text-primary-600 hover:underline text-[1rem] dark:text-primary-500"
                      >
                        Login
                      </p>
                    </div>
