...
function Login({ toggleMode }: LoginProps) {
  ...
  return (
    <>
       <section onClick={(e) => e.stopPropagation()} className=" z-50 w-[43.75rem] py-10 ">
                 ...
                 <div className="flex items-center justify-between">
                   ...
                   <Fade direction="up" triggerOnce>
                     <p
                       ...
                       className="text-[1rem] text-gray-200 text font-medium text-primary-600 hover:underline dark:text-primary-500"
                     >
                       Forgot password?
                     </p>
                   </Fade>
